...
<Alpha {...this.props} pointer={CustomPointer} onChange={this.handleChange} />;
```
...
<EditableInput style={inputStyles} label="hex" value={this.props.hex} onChange={this.handleChange} />;
```
...
<Hue {...this.props} pointer={CustomPointer} onChange={this.handleChange} direction={'horizontal' || 'vertical'} />;
```
...
<Saturation {...this.props} pointer={CustomPointer} onChange={this.handleChange} />;
```
