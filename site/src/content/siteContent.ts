    ...
    subsections: [
      {
        id: 'install',
        title: 'Install',
        intro: 'Add react-color-x to your project with your package manager of choice.',
        blocks: [
          {
            type: 'package-manager',
            label: 'Install package',
            commands: {
              npm: 'npm install react-color-x --save',
              pnpm: 'pnpm add react-color-x',
              yarn: 'yarn add react-color-x',
              bun: 'bun add react-color-x',
            },
          },
          {
            type: 'text',
          ...
          },
          {
            type: 'code',
            language: 'tsx',
            code: "import { SketchPicker } from 'react-color-x'\n",
            label: 'Basic import',
          },
        ],
      },
      {
        ...
        intro:
          'Import a picker from react-color-x at the top of your component and render it like any other React component.',
        blocks: [
          {
            type: 'code',
            language: 'tsx',
          ...
          },
          {
            type: 'code',
            language: 'tsx',
            code: "import { ChromePicker, SketchPicker } from 'react-color-x';\n",
      ...
      },
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            code: "import 'react-color-x/es/styles/common/editable-input.css';\n",
          },
        ],
      },
    ],
        ...
        blocks: [
          {
            type: 'bullets',
            items: [
              "Default export remains the Chrome picker wrapped with ColorWrap, so `import Chrome from 'react-color-x'` keeps the original default-import mental model after switching package names.",
        ...
        blocks: [
          {
            ...
            items: [
              ...
              'Keep framework wrappers thin so the public `react-color-x` API stays the source of truth for color state and callbacks.',
            ],
          },
        ],
      },
