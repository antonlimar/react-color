...
export const pickerMetadata: readonly PickerMetadata[] = [
  {
    ...
    deepImport: '@antonlimar/react-color',
    ...
    subsections: [
      {
        id: 'install',
        title: 'Install',
        intro: 'Add @antonlimar/react-color to your project with your package manager of choice.',
        blocks: [
          {
          ...
          {
            type: 'text',
            text: 'Root picker imports include their published CSS automatically, so normal usage does not need any extra setup.',
          },
          {
            type: 'code',
            language: 'tsx',
            code: "import { SketchPicker } from '@antonlimar/react-color'\n",
            label: 'Basic import',
          },
        ],
      },
      {
        ...
        intro:
          'Import a picker from @antonlimar/react-color at the top of your component and render it like any other React component.',
        blocks: [
          {
            type: 'code',
            language: 'tsx',
          ...
          {
            type: 'text',
            text: 'Use named picker imports from the package root to keep the public API stable for existing integrations.',
          },
          {
            type: 'code',
            language: 'tsx',
            code: "import { ChromePicker, SketchPicker } from '@antonlimar/react-color';\n",
            label: 'Named picker imports',
          },
          {
            type: 'text',
            text: 'Styling is driven by published CSS entrypoints and public class hooks. Root picker imports include their CSS automatically, and you can customize the result with className, classNames, theme, and CSS custom properties.',
          },
        ],
      },
    ],
        ...
        blocks: [
          {
            type: 'bullets',
            items: [
              'Root picker imports include their published CSS automatically.',
          ...
          },
          {
            ...
            code: "import '@antonlimar/react-color/es/styles/common/editable-input.css';\n",
          },
        ],
      },
    ],
        ...
        blocks: [
          {
            type: 'bullets',
            items: [
              "Default export remains the Chrome picker wrapped with ColorWrap, so `import Chrome from '@antonlimar/react-color'` keeps the original default-import mental model after switching package names.",
              'Named picker exports keep the same top-level component names through the package root.',
              'CSS entrypoints are still published, and root picker imports include their styles automatically for normal usage.',
        ...
        blocks: [
          {
            ...
            items: [
              ...
              'Keep framework wrappers thin so the public `@antonlimar/react-color` API stays the source of truth for color state and callbacks.',
            ],
          },
        ],
      },
