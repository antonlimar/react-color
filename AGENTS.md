...
Следующая крупная отдельная волна — дальнейшая styling modernization: сокращение оставшихся inline styles, расширение поддерживаемых CSS hooks и полировка styling API. Это не делать «заодно» с обычными багфиксами или мелкими улучшениями.
