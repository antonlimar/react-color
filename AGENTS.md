...
Следующая крупная отдельная волна — styling modernization: уход от `reactcss` к более современной styling-системе. Это не делать «заодно» с обычными багфиксами или мелкими улучшениями.
